...
public class PlayerHealth : MonoBehaviour
{
    ...
    void Awake ()
    {
        ...
        LogManager.logManager.AddEvent(Time.time, "Player;Starting;Health;" + currentHealth);
    }
    ...
    void Update ()
    {
        ...
        if(isDead)
        {
            ...
            {
                LogManager.logManager.AddEvent(Time.time, "KeyPress;C");
                Application.Quit(); // ignored in UnityEditor
                EditorApplication.isPlaying = false;
            }
        } 
    ...
    public void TakeDamage (int amount)
    {
        ...
        LogManager.logManager.AddEvent(Time.time, "Player;Health;DecreaseTo;" + currentHealth);
    ...
    void Death ()
    {
        LogManager.logManager.AddEvent(Time.time, "Player;Death");
