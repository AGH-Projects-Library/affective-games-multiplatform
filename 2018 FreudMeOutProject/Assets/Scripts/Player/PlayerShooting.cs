...
public class PlayerShooting : MonoBehaviour
{
    ...
    void Awake ()
    {
        ...
        LogManager.logManager.AddEvent(Time.time, "Player;Starting;Range;" + range);
        LogManager.logManager.AddEvent(Time.time, "Player;Starting;TimeBetweenBullets;" + timeBetweenBullets);
        LogManager.logManager.AddEvent(Time.time, "Player;Starting;DamagerPerShot;" + damagePerShot);
        LogManager.logManager.AddEvent(Time.time, "Player;Starting;SuperPower;" + ultraPower);
    }
    ...
    void UseSuperPower(float timeSuper, float timeMax, bool was)
    {
        if((timeSuper > 0 && was)  && ultraPower > 0)
        {
            ...
            LogManager.logManager.AddEvent(Time.time, "Player;SuperPower;Kill;" + killed);
