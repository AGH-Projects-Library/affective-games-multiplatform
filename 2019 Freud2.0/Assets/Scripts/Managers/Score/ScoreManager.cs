...
public class ScoreManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Score=0;
        if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex>2) scoreToLevelUp = Random.Range(scoreToLevelUp-100, scoreToLevelUp);
    ...
    public static void AddScore(int value)
    {
        ...
        if (Score>=Instance.scoreToLevelUp) OnLevelUpReached?.Invoke();
    }
}
